    ...
    <div className="mb-16">
      <form action={handleFormSubmit} className="w-1/2">
        ...
        <div className="relative flex rounded-lg shadow-sm">
          <input type="text" id="search-field" inputMode="search" value={query} name="query" onChange={handleInputChange} className="py-3 px-4 ps-11 block w-full border-gray-200 shadow-sm rounded-s-lg text-sm focus:z-10 focus:border-rose-500 focus:ring-rose-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-gray-800 dark:border-gray-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" />
